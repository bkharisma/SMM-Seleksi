...
interface Tahap2Props {
    peserta: PesertaTahap2Result | null;
}

export default function KelulusanTahap2({ peserta }: Tahap2Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post('/kelulusan/tahap-2');
    };

    return (
        <PortalLayout title="Pengumuman Kelulusan Tahap 2">
            <Head title="Pengumuman Kelulusan Tahap 2" />
            ...
            <div className="mx-auto max-w-3xl">
                {!peserta ? (
                    <Card title="Cek Kelulusan Tahap 2">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <p className="text-sm text-gray-600 dark:text-gray-400">
                                Masukkan NUP dan password Anda untuk melihat hasil kelulusan Tahap 2 (seleksi akhir).
                            </p>
                            <Input
                                id="nup"
                    ...
                    <div className="space-y-6">
                                ...
                                {peserta.status_kelulusan === 'lulus' ? (
                                    <div className="rounded-lg bg-green-50 p-6 text-center dark:bg-green-900/20">
                                        ...
                                        <p className="mt-2 text-green-700 dark:text-green-400">
                                            Anda dinyatakan <strong>LULUS</strong> seleksi Tahap 2 (Seleksi Akhir).
                                        </p>
                                        {peserta.lulus_prodi && (
                                    ...
                                    <div className="rounded-lg bg-red-50 p-6 text-center dark:bg-red-900/20">
                                        ...
                                        <p className="mt-2 text-red-700 dark:text-red-400">
                                            Maaf, Anda tidak memenuhi kriteria kelulusan Tahap 2.
                                        </p>
                                    </div>
                                ) : (
                                    <div className="rounded-lg bg-yellow-50 p-6 text-center dark:bg-yellow-900/20">
                                        ...
                                        <p className="mt-2 text-yellow-700 dark:text-yellow-400">
                                            Proses seleksi Tahap 2 belum dilaksanakan. Silakan periksa kembali secara berkala.
                                        </p>
                                    </div>
                                )}
                            </div>
                        ...
                        {peserta.detail && (
                            <Card title="Hasil Evaluasi Tahap 2">
