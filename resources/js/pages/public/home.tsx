                    ...
                    <div className="max-w-[1200px] mx-auto px-gutter grid grid-cols-1 md:grid-cols-2 items-center gap-cl md:gap-cxl">
                        <div className="z-10">
                            ...
                            <div className="flex flex-wrap gap-sm">
                                <RegistrationLink className="inline-block bg-primary-container text-on-primary-container font-button text-button px-sm md:px-cxl py-xs md:py-cs rounded-lg shadow-md hover:opacity-90 transition-all">Daftar Sekarang</RegistrationLink>
                            </div>
                        </div>
