    ...
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('member/dashboard', [
            'peserta' => $peserta ? [
                ...
                'no_hp' => $peserta->no_hp,
                'nilai' => [
                    'psikotes' => $peserta->nilai?->firstWhere('type', 'PSI')?->skor_akhir,
                    'inggris' => $peserta->nilai?->firstWhere('type', 'LBI')?->skor_akhir,
                    'wawancara' => $peserta->nilai?->firstWhere('type', 'WW')?->skor_akhir,
                    'kesehatan' => $peserta->nilai?->firstWhere('type', 'KSH')?->skor_akhir,
                ],
