    ...
    return (
        <div className="w-full">
            ...
            <div className="flex items-center gap-4">
                <label className="flex cursor-pointer items-center gap-2 rounded-lg border border-dashed border-outline-variant px-4 py-3 hover:border-primary">
                    ...
                    <span className="text-sm text-on-surface-variant">Pilih file</span>
            ...
            {maxSize && <p className="mt-1 text-xs text-on-surface-container">Ukuran maksimal: {maxSize}</p>}
